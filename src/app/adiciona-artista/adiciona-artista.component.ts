...
@Component({
	selector: 'app-adiciona-artista',
	templateUrl: './adiciona-artista.component.html',
	styleUrls: ['./adiciona-artista.component.scss']
})
export class AdicionaArtistaComponent implements OnInit {
